...
class Settings(BaseSettings):
    ...
    rapidapi_key_shopee: Optional[str] = Field(default=None, alias="RAPIDAPI_KEY_SHOPEE")
    rapidapi_host_shopee: Optional[str] = Field(default=None, alias="RAPIDAPI_HOST_SHOPEE")
